...
<body>
    <div class="container pb-5 mb-5">
        ...
        <div class="header-profile">
            <div class="d-flex align-items-center">
                <div class="me-3">
                    <img src="{{ asset('images/default-avatar.png') }}" alt="Profile" class="profile-img">
                </div>
                <div>
        ...
        <div class="nav-menu">
            <div class="row g-0">
                ...
                <div class="col-3 nav-item">
                    ...
                    <div class="nav-text">Cuti</div>
                </div>
                <div class="col-3 nav-item">
                    <div class="nav-icon">
                        <i class="fas fa-history"></i>
                    </div>
                    <div class="nav-text">Histori</div>
                </div>
                <div class="col-3 nav-item">
                    <div class="nav-icon">
                        <i class="fas fa-map-marker-alt"></i>
                    </div>
                    <div class="nav-text">Lokasi</div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                <div class="col-6">
                    <div class="btn-checkin">
                        ...
                        <div class="attendance-time">07:00</div>
                    </div>
                </div>
                <div class="col-6">
        ...
        <div class="chart-container">
            <h6 class="mb-4">Statistik Kehadiran Bulan Ini</h6>
            ...
            <div class="mt-3">
                <div class="stats-label">
                    <div class="color-dot" style="background-color: var(--present-blue);"></div>
                    <div>Hadir - 42.9%</div>
                </div>
                <div class="stats-label">
                    <div class="color-dot" style="background-color: var(--sick-orange);"></div>
                    <div>Sakit - 25.8%</div>
                </div>
                <div class="stats-label">
                    <div class="color-dot" style="background-color: var(--permit-green);"></div>
                    <div>Izin - 17.2%</div>
                </div>
                <div class="stats-label">
                    <div class="color-dot" style="background-color: var(--late-red);"></div>
                    <div>Terlambat - 14.2%</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bottom-nav">
        <div class="row g-0">
            ...
            <div class="col bottom-nav-item">
                <div class="bottom-nav-icon active-nav">
                    <i class="fas fa-user"></i>
                </div>
