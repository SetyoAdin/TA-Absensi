        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                ...
                <div class="container mt-5">
                    @yield('content') {{-- Tempat menampilkan konten halaman --}}
                </div>

                @yield('scripts') {{-- Untuk script tambahan setiap halaman --}}
            </main>
        </div>
    </div>
</body>
